document.addEventListener('DOMContentLoaded', function() {
    ...
    if(inpWrap) {
        ...
        const inpTxt = inpWrap.querySelector('p.required');
        ...
        // 상태 초기화
        function resetState() {
            input.classList.remove(CLASS.focus, CLASS.completed, CLASS.error);
            inpTxt.classList.remove(CLASS.focus, CLASS.completed, CLASS.error);
            inpTxt.innerText = ''
        }
